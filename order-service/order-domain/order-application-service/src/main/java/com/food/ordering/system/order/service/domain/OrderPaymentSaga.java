...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    public void rollback(PaymentResponse paymentResponse) {
        Optional<OrderPaymentOutboxMessage> paymentOutboxMessageResponse =
                paymentOutboxHelper.getPaymentOutboxMessageBySagaIdAndSagaStatus(
                        UUID.fromString(paymentResponse.getSagaId()),
                        getSagaStatus(paymentResponse.getPaymentStatus())
                );
    ...
    private OrderApprovalOutboxMessage getUpdatedApprovalOutboxMessage(
        ...
        if (orderApprovalOutboxMessageResponse.isEmpty()) {
            throw new OrderDomainException("getUpdatedApprovalOutboxMessage() Approval outbox message could not be found in " +
